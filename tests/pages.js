(function () {
    ...
    var pages = {
        flightSearchResults: {
            delay: "function(){if(document.getElementById(\"noflightsfoundfilter\")!==null&&document.getElementById(\"noflightsfoundfilter\").innerHTML.indexOf(\"Sorry, we're having a problem on our end.\") > 0){console.error(\"No flight results... service is probably down :(\");return \"exit\";}return location.href.indexOf(\"Flights-Search\")>0&&document.getElementById(\"flightModuleList\")!==null&&document.getElementById(\"flightModuleList\").innerHTML.length>100&&document.readyState===\"complete\";}",
            load: function runner_interaction_flightSearchResults(page, pos) {
                var aa = new Date(),
                    am = aa.getMonth(),
                    ad = aa.getDate(),
                    bm = 0,
